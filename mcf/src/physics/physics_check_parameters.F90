      LOGICAL FUNCTION physics_check_parameters(this,stat_info)
        ...
        DO i = 1, dim
           ...
           IF ( this%bcdef(2*i-1) == mcf_bcdef_periodic .AND. &
           ...
           IF ( this%bcdef(2*i) == mcf_bcdef_periodic .AND. &
           ...
           IF ( this%bcdef(2*i-1) == mcf_bcdef_wall_solid .AND. &
                this%bcdef(2*i)  /= this%bcdef(2*i-1) ) THEN
              PRINT *, "physics_check_parameters : ", &
           ...
           IF ( this%bcdef(2*i) == mcf_bcdef_wall_solid .AND. &
                this%bcdef(2*i-1)  /= this%bcdef(2*i) ) THEN
              PRINT *, "physics_check_parameters : ", &
                   "solid wall boundary must be pair-wise !"
              lcheck = .FALSE.
           ...
           IF ( this%bcdef(2*i-1) == mcf_bcdef_LE .AND. &
                this%bcdef(2*i)  /= this%bcdef(2*i-1) ) THEN
              PRINT *, "physics_check_parameters : ", &
           ...
           IF ( this%bcdef(2*i) == mcf_bcdef_LE .AND. &
                this%bcdef(2*i-1)  /= this%bcdef(2*i) ) THEN
              PRINT *, "physics_check_parameters : ", &
                   "Lees-Edwards boundary must be pair-wise !"
              lcheck = .FALSE.
