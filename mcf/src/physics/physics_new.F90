	...
	this%k_sm = 0.0_MK
        ...
        this%bcdef(1:4)       = mcf_bcdef_periodic
      ...
      SUBROUTINE physics_display_parameters(this,stat_info)
        ...
        PRINT *, "kt               : ", this%kt 
        PRINT *, "rho variation    : ", this%rho_var
        PRINT *, "c                : ", this%c 
        PRINT *, "back. pressure   : ", this%bp 
        PRINT *, "len_ref          : ", this%len_ref
        PRINT *, "rho_ref          : ", this%rho_ref
        PRINT *, "vel_ref          : ", this%vel_ref
