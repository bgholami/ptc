...
!!$             this%num_cell_dim_sub,stat_info_sub)  qxb : this%num_cell_dim_sub is included in cell_list data structure

        CALL ppm_neighlist_clist(this%topo_id, &
             x, num_part,&
             cell_size,symmetry,&
             this%cell_list,&
             stat_info_sub)        
...
!!$             this%num_cell_dim_sub_c,stat_info_sub) qxb : this%num_cell_dim_sub_c is included in cell_list data structure   
