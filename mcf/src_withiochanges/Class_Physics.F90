	...
	!----------------------------------------------------
        ...
        TYPE Physics
           ...
           ! ksai    : bulk viscosity.
           ! c       : sound speed.
           ! rho_var : density variation
           ! pb      : background pressure 
           ! len_ref   : reference length. 
           ! rho_ref : reference density.
           ! vel_ref   : reference velocity.
	   ...
	   !			4 stochastic force
           ...
           !----------------------------------------------------
           ! Additional parameters for tracers ONLY:
           !
           ! tracers_radius      : tracers' radius
           ! tracers_rho_ratio   : tracers' density ratio (rho_particles/rho_tracers)
           ! tracers_c_factor    : number of tracers on each SPH particle
           ! tracers_dp          : diffusion coefficient of tracers
           ! tracers_near_wall   : Near-wall region distance
           ! tracers_restart_num : number of tracers in case of restart file
           !
           !----------------------------------------------------
...
#include "src/physics/physics_new.F90"
#include "src/physics/physics_finalize.F90"
#include "src/physics/physics_check_parameters.F90"
#include "src/physics/physics_adjust_parameters.F90"
#include "src/physics/physics_compute_cs.F90"
#include "src/physics/physics_initialize_dt.F90"
#include "src/physics/physics_adapt_dt.F90"
#include "src/physics/physics_get.F90"
#include "src/physics/physics_set.F90"
