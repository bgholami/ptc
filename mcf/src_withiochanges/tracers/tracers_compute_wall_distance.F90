SUBROUTINE tracers_compute_wall_distance(this, func, stat_info)
  ...
  INTEGER ,                 INTENT(IN)    :: func ! 0 particle, 1 tracer with id modification for those that leave, 2 tracer with id modification for those that leave and those that deposit
     ...
     IF ((this%id(2,ip) == 0) .AND. (this%id(3,ip) == 0)) THEN
        ...
        IF ( (func >= 1) .OR. & ! i.e. tracer
           ...
           IF (func >= 1) THEN
              ...
              IF (this%h_p(ip) < 2.0_MK * a_p) THEN
