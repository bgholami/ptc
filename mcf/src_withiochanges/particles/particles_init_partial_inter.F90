	...
	!----------------------------------------------------
        ...
        !----------------------------------------------------
        ! Allocate memory for tracers concentration on SPH particles
        !----------------------------------------------------
        ...
        ALLOCATE(this%c_tracers(num_part_real), STAT=stat_info_sub)
        this%c_tracers(1:num_part_real) = 0.0_MK
