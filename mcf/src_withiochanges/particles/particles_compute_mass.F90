      SUBROUTINE particles_compute_mass(this,stat_info) 
        ...
        ! Reference   :
        !
        ! Remark      : For moment inertia of ellipse,
        !               see http://www.eformulae.com/
        !               engineering/moment_of_inertia.php
        !
        !
        ! Revisions   : V0.2 17.12.2009, including mass moment
        !               inertia of ellipse.
        !
           ...
           DO i = 1, num_colloid
              ...
              IF (num_dim == 2) THEN
                 ...
                 CASE( mcf_colloid_shape_sphere )
                    ...
                    coll_mmi(i) = 0.5_MK*coll_m(i)*coll_radius(1,i)**2
                 ...
                 IF ( num_sym > 0 ) THEN
                    ...
                    coll_mmi(i) = coll_mmi(i) / REAL(num_sym,MK)
              ...
              ELSE IF (num_dim ==3 ) THEN
                 ...
                 CASE(1)
                    ...
                    coll_m(i)   = init_rho*coll_vol
                    coll_mmi(i) = 0.4_MK*coll_m(i)*coll_radius(1,i)**2
