...
#if __TRACER
        this%output_tracers_file  = TRIM("mcf_tracers")
        this%output_tracers_unit  = 33
        this%output_tracers_fmt   = TRIM("FORMATTED")
        this%output_tracers_freq_step  = 100
        this%output_tracers_freq_time  = 0.1_MK
        this%output_tracers_freq_time_num = 0   

        this%read_tracers_file  = TRIM("mcf_tracers") 
        this%read_tracers_unit  = 34
        this%read_tracers_fmt   = TRIM("FORMATTED")
        this%read_tracers_file  = TRIM("deposited_tracers")
        this%read_tracers_unit  = 35
#endif
...
9999    CONTINUE
      ...
      SUBROUTINE io_display_parameters(this,stat_info)
...
#if __TRACER
        read_tracers = &
             control_get_read_tracers(this%ctrl,stat_info_sub)
#endif
        relax_run     = &
        ...
        IF( read_tracers ) THEN
           ...
           PRINT *, "read_tracers_file          : ", TRIM(this%read_tracers_file)
           PRINT *, "read_tracers_unit          : ", this%read_tracers_unit 
           PRINT *, "read_deposited_file        : ", TRIM(this%read_deposited_file)
           PRINT *, "read_deposited_unit        : ", this%read_deposited_unit
           PRINT *, "read_tracers_format        : ", TRIM(this%read_tracers_fmt)
        ...
        IF ( this%write_output > 0 .AND. &
           ...
           PRINT *, "output_tracers_file      : ", TRIM(this%output_tracers_file), &
                "****.out"
           PRINT *, "output_tracers_unit      : ", this%output_tracers_unit
           PRINT *, "output_tracers_format    : ", TRIM(this%output_tracers_fmt)
           
           SELECT CASE ( this%write_output )
           CASE (1)
              PRINT *, "output_tracers_freq_step : ", this%output_tracers_freq_step
           CASE (2)
              PRINT *, "output_tracers_freq_time : ", this%output_tracers_freq_time
           END SELECT 
