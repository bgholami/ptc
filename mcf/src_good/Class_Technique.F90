      MODULE Class_Technique
        ...
        TYPE Technique
           ...
           TYPE(ppm_t_clist),DIMENSION(:),POINTER     :: cell_list_c 
...
#include "src/technique/technique_new.F90"
#include "src/technique/technique_finalize.F90"
#include "src/technique/technique_build_list.F90"
#include "src/technique/technique_get.F90"
