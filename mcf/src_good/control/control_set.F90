...
#if __TRACER 
      SUBROUTINE control_set_read_tracers(this,d_read_tracers,stat_info)
        
        TYPE(Control), INTENT(INOUT)             :: this
        LOGICAL, INTENT(IN)                      :: d_read_tracers
        INTEGER, INTENT(out)                     :: stat_info
        
        stat_info = 0
        
        this%read_tracers =d_read_tracers
        
        RETURN
        
      END SUBROUTINE control_set_read_tracers
#endif
