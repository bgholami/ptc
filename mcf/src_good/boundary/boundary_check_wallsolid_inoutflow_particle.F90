      SUBROUTINE boundary_check_wallsolid_inoutflow_particle(this,&
        ...
        ! p_sid     : species ID.
        ! p_bid     : if not wall, indicates inflow (1) or outflow (-1)
        ...
        DO i = 1, num_dim
           ...
           IF ( p_x(i) <= this%min_phys(i) .AND. &
              ...
              ELSE IF ( this%bcdef(2*i-1) == &
                   mcf_bcdef_inflow ) THEN
