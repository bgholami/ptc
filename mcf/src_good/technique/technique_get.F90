      ...
      SUBROUTINE technique_get_cell_list(this,&
           d_num_sub, d_cell_list, &
           d_inp, d_jnp, d_nnp, d_sub_bcdef, stat_info)
        
        TYPE(Technique),INTENT(IN)              :: this
        INTEGER, INTENT(OUT)                    :: d_num_sub
        ! TYPE(ppm_type_ptr_to_clist),DIMENSION(:),POINTER      :: d_cell_list qxb
        TYPE(ppm_t_clist),DIMENSION(:),POINTER  :: d_cell_list
...
!!$             SIZE(this%num_cell_dim_sub,2))) qxb
        ...
        !d_num_cell_dim_sub(:,:) = this%num_cell_dim_sub(:,:) qxb
      ...
      SUBROUTINE technique_get_cell_list_c(this,&
           d_num_sub, & !d_num_cell_dim_sub,& qxb
           d_cell_list,d_inp,d_jnp,d_nnp,d_sub_bcdef,stat_info)
        
        TYPE(Technique),INTENT(IN)              :: this
        INTEGER, INTENT(OUT)                    :: d_num_sub
        !INTEGER,DIMENSION(:,:),POINTER          :: d_num_cell_dim_sub qxb
        !TYPE(ppm_type_ptr_to_clist),DIMENSION(:),POINTER      :: d_cell_list  qxb
        TYPE(ppm_t_clist),DIMENSION(:),POINTER  :: d_cell_list
        INTEGER,DIMENSION(:,:),POINTER          :: d_inp
        INTEGER,DIMENSION(:,:),POINTER          :: d_jnp
...
!!$             SIZE(this%num_cell_dim_sub_c,2))) qxb
        ...
        d_num_sub               = this%num_sub
        !d_num_cell_dim_sub(:,:) = this%num_cell_dim_sub_c(:,:) qxb
