      SUBROUTINE particles_map_ghost_get( this,&
        ...
        CALL boundary_get_shear_length(d_boundary, &
	...
	!----------------------------------------------------
        ...
        IF ( map_x ) THEN
           ...
           IF ( num_le > 0 ) THEN
              ...
              ! not sure how this should be, for now no LE!!
              CALL ppm_map_part_ghost_get(topo_id, &
                   this%x, num_dim, this%num_part_real, &
                   isymm, ghost_size, stat_info_sub)
        ...
        !----------------------------------------------------
        ! store the current/active particle mapping  
        !----------------------------------------------------

        !CALL ppm_map_part_store(stat_info_sub)
