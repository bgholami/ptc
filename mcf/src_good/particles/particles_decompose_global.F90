      SUBROUTINE particles_decompose_global(this, &
        ...
        !USE ppm_module_map qxb
        !USE ppm_module_topo  qxb
        !USE ppm_module_find_duplicates qxb
        ...
        IF ( num_wall_solid > 0 ) THEN
           ...
           num_part_wall_solid = &
                boundary_get_num_part_wall_solid(d_boundary,stat_info_sub)
	...
	!------------------------------------------
        ...
        !map_type = ppm_param_map_global qxb
        ...
        IF ( map_x ) THEN
           ...
           !     topo_id,map_type,stat_info_sub)  qxb

           CALL ppm_map_part_global(topo_id, &
                this%x, &
                this%num_part_real, &
                stat_info_sub)       
        ...
        !map_type = ppm_param_map_push qxb
        ...
        IF ( map_c_tracers) THEN
           ...
           !CALL ppm_map_part(this%c_tracers,&
           !     this%num_part_real,this%num_part_all,&
           !     topo_id,map_type,stat_info_sub)
        ...
        !--------------------------------
        ! tracer concentration evolution
        !-------------------------------- 

        IF ( map_dn) THEN
           
           !CALL ppm_map_part(this%dn,&
           !     this%num_part_real,this%num_part_all,&
           !     topo_id,map_type,stat_info_sub) 
        ...
        ! map_type = ppm_param_map_pop qxb
        ...
        IF ( map_c_tracers) THEN
           ...
           CALL ppm_map_part_pop(this%c_tracers, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_act) THEN
           ...
           CALL ppm_map_part_pop(this%act, num_dim**2, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_ct) THEN
           ...
           CALL ppm_map_part_pop(this%ct, num_dim**2, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_aevec) THEN
           ...
           CALL ppm_map_part_pop(this%aevec, num_dim**2, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_evec) THEN
           ...
           CALL ppm_map_part_pop(this%evec, num_dim**2, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_aeval) THEN
           ...
           CALL ppm_map_part_pop(this%aeval, num_dim, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_eval) THEN
           ...
           CALL ppm_map_part_pop(this%eval, num_dim, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_evgt) THEN
           ...
           CALL ppm_map_part_pop(this%evgt, num_dim**2, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_vgt) THEN
           ...
           CALL ppm_map_part_pop(this%vgt, num_dim**2, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_f) THEN    
           ...
           CALL ppm_map_part_pop(this%f_bp, num_dim, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
        ...
        IF( map_rho) THEN
           ...
           CALL ppm_map_part_pop(this%rho, &
                this%num_part_real, &
                this%num_part_all, stat_info_sub)
