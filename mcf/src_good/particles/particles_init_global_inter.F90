      SUBROUTINE particles_init_global_inter(this, d_rank,stat_info)
        ...
        ! d_boundar        : pointer to a boundary obeject.
        ...
        num_inflow = &
             boundary_get_num_inflow(d_boundary,stat_info_sub)   
        num_outflow = &
             boundary_get_num_outflow(d_boundary,stat_info_sub)
        ...
        DO j = 1, num_total
           ...
           IF ( (num_wall_solid > 0)  .OR. &
              ...
              CALL boundary_check_wallsolid_inoutflow_particle(d_boundary, &
                   this%x(1:num_dim,j), l_w, p_sid, p_bid, stat_info_sub)
