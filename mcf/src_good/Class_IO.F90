...
#if __TRACER
           CHARACTER(LEN=MAX_CHAR)      :: output_tracers_file
           INTEGER                      :: output_tracers_unit
           CHARACTER(LEN=MAX_CHAR)      :: output_tracers_fmt
           INTEGER                      :: output_tracers_freq_step
           REAL(MK)                     :: output_tracers_freq_time
           INTEGER                      :: output_tracers_freq_time_num

           CHARACTER(LEN=MAX_CHAR)      :: read_tracers_file
           INTEGER                      :: read_tracers_unit
           CHARACTER(LEN=MAX_CHAR)      :: read_tracers_fmt  

           CHARACTER(LEN=MAX_CHAR)      :: read_deposited_file
           INTEGER                      :: read_deposited_unit
...
#include "src/io/io_new.F90"
#include "src/io/io_finalize.F90"
#include "src/io/io_check_parameters.F90"
#include "src/io/io_adjust_parameters.F90"
#include "src/io/io_get.F90"
#include "src/io/io_open.F90"
#include "src/io/io_read.F90"
#include "src/io/io_write.F90"
#include "src/io/io_write_condition.F90"
#include "src/io/io_close.F90"
