...
!--------------------------------------------------
      ...
      REAL(MK) FUNCTION physics_get_bp(this,stat_info)
        ...
        physics_get_bp = this%bp
        
        RETURN
        
      END FUNCTION physics_get_bp
      ...
      ! Additional functions for the use of tracers only.

      REAL(MK) FUNCTION physics_get_tracers_radius(this,stat_info)
        ...
        physics_get_tracers_radius = this%tracers_radius
        
        RETURN
        
      END FUNCTION physics_get_tracers_radius   
   

      REAL(MK) FUNCTION physics_get_tracers_rho_ratio(this,stat_info)
        ...
        physics_get_tracers_rho_ratio = this%tracers_rho_ratio
        
        RETURN
        
      END FUNCTION physics_get_tracers_rho_ratio


      INTEGER  FUNCTION physics_get_tracers_c_factor(this,stat_info)
        ...
        physics_get_tracers_c_factor = this%tracers_c_factor
        
        RETURN
        
      END FUNCTION physics_get_tracers_c_factor 


      REAL(MK) FUNCTION physics_get_tracers_diffusion(this,stat_info)
        ...
        physics_get_tracers_diffusion = this%tracers_dp
        
        RETURN
        
      END FUNCTION physics_get_tracers_diffusion


      REAL(MK) FUNCTION physics_get_tracers_near_wall(this,stat_info)
        ...
        physics_get_tracers_near_wall = this%tracers_near_wall
        
        RETURN
        
      END FUNCTION physics_get_tracers_near_wall  

      INTEGER FUNCTION physics_get_tracers_restart_num(this,stat_info)
        ...
        physics_get_tracers_restart_num = this%tracers_restart_num
        
        RETURN
        
      END FUNCTION physics_get_tracers_restart_num

      
      INTEGER FUNCTION physics_get_tracers_nbond(this,stat_info)
        ...
        physics_get_tracers_nbond = this%tracers_nbond
        
        RETURN
        
      END FUNCTION physics_get_tracers_nbond     


      REAL(MK) FUNCTION physics_get_tracers_K0(this,stat_info)
        ...
        physics_get_tracers_K0 = this%tracers_K0
        
        RETURN
        
      END FUNCTION physics_get_tracers_K0


      REAL(MK) FUNCTION physics_get_tracers_A(this,stat_info)
        ...
        physics_get_tracers_A = this%tracers_a
        
        RETURN
        
      END FUNCTION physics_get_tracers_A


      REAL(MK) FUNCTION physics_get_tracers_B(this,stat_info)
        ...
        physics_get_tracers_B = this%tracers_b
        
        RETURN
        
      END FUNCTION physics_get_tracers_B


      REAL(MK) FUNCTION physics_get_tracers_C(this,stat_info)
        ...
        physics_get_tracers_C = this%tracers_c
        
        RETURN
        
      END FUNCTION physics_get_tracers_C


      REAL(MK) FUNCTION physics_get_tracers_D(this,stat_info)
        ...
        physics_get_tracers_D = this%tracers_d
        
        RETURN
        
      END FUNCTION physics_get_tracers_D
