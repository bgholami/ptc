      SUBROUTINE colloid_in_nearest_image(this,x,sid, &
        ...
        CASE (mcf_colloid_shape_rectangle) 
           ...
           d_max = SQRT(this%radius(1,sid)**2 + this%radius(2,sid)**2)

           d_max = d_max / 2.0_MK
           
        CASE (mcf_colloid_shape_arbitrary) 
           
           !d_max = MAXVAL(length) ! for now §§§ 
           d_max = MAXVAL(this%max_phys_t(1:dim) - this%min_phys_t(1:dim))
        ...
        IF ( num_le > 0 ) THEN
           ...
           DO i = 1, dim
              ...
              ELSE IF ( -rx(i) > d_max .AND. &
                   this%bcdef(2*i) == mcf_bcdef_LE ) THEN
        ...
        DO i = 1, dim
           ...
           IF ( rx(i) > d_max ) THEN
              ...
              IF ( (this%bcdef(2*i-1) == mcf_bcdef_inflow) .OR. &
              ...
              ELSE IF ( this%bcdef(2*i-1) == mcf_bcdef_periodic ) THEN
           ...
           ELSE IF ( -rx(i) > d_max  ) THEN
              ...
              IF ( (this%bcdef(2*i) == mcf_bcdef_inflow) .OR. &
              ...
              ELSE IF ( this%bcdef(2*i) ==  mcf_bcdef_periodic ) THEN
