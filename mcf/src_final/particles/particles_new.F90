      SUBROUTINE particles_init(this,d_ctrl,d_phys,&
        ...
        this%radius = &
             physics_get_tracers_radius(this%phys,stat_info_sub)
        this%rho_ratio  = &
             physics_get_tracers_rho_ratio(this%phys,stat_info_sub)
        this%c_factor = &
             physics_get_tracers_c_factor(this%phys,stat_info_sub)
        this%dp = &
             physics_get_tracers_diffusion(this%phys,stat_info_sub)

        this%tau_p = 0.0_MK
        this%m_p = 0.0_MK

        this%last_local_id = 0

        this%near_wall = &
             physics_get_tracers_near_wall(this%phys,stat_info_sub)
        NULLIFY(this%x_interface)
        NULLIFY(this%vo_interface) 
        NULLIFY(this%vc_interface)
        NULLIFY(this%vn_interface)
        NULLIFY(this%local_interface)
        NULLIFY(this%insertion_list)
        NULLIFY(this%num_interface)
        NULLIFY(this%c_tracers) 
        NULLIFY(this%dn)  
        NULLIFY(this%h_p)
        NULLIFY(this%n_vec)
        NULLIFY(this%facet) 
        ...
        ! set tracer adhesion parameters
        this%nbond = physics_get_tracers_nbond(this%phys, stat_info_sub) 
        this%K0    = physics_get_tracers_K0(this%phys, stat_info_sub) 
        this%baa   = physics_get_tracers_A(this%phys, stat_info_sub) 
        this%bab   = physics_get_tracers_B(this%phys, stat_info_sub)
        this%bac   = physics_get_tracers_C(this%phys, stat_info_sub)
        this%bad   = physics_get_tracers_D(this%phys, stat_info_sub)
