...
9999    CONTINUE
      ...
      SUBROUTINE particles_get_f_bp(this,f,num,stat_info)
        ...
        IF( num > 0 ) THEN
           ...
           dim = SIZE(this%f_bp,1)
           
           ALLOCATE(f(dim,num))
           
           f(1:dim,1:num) = this%f_bp(1:dim,1:num)
...
9999    CONTINUE
      ...
      END SUBROUTINE particles_get_f_bp
...
#if __TRACER       
      SUBROUTINE particles_get_c_tracers(this,c_tracers,num,stat_info)
        ...
        ALLOCATE(c_tracers(num))

        c_tracers(1:num) = this%c_tracers(1:num)
...
9999    CONTINUE
      ...
      END SUBROUTINE particles_get_c_tracers
#endif       
