     SUBROUTINE tracers_adjust_tracers(this,num,stat_info)
	!----------------------------------------------------
     	! Subroutine  : tracers_adjust_tracers
	!----------------------------------------------------
      	!
           ...
           DO i = 1, num_dim
              ...
              IF ( this%x(i,j) <  min_phys(i) ) THEN
                 ...
                 CASE ( mcf_bcdef_periodic ) 
                    ...
                    ! ignore periodic for now and delete instead.
                    ! (to avoid PPM crash periodic is applied but 
                    ! tracers are marked to be deleted.)
                    this%id(1, j) = 0
                    this%id(2, j) = -1 ! delete without insertion into SPH particle
...
9999    CONTINUE	
      ...
      END SUBROUTINE tracers_adjust_tracers
