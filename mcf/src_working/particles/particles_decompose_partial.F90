      SUBROUTINE particles_decompose_partial(this,&
        ...
        !                
        !
        ! Revisions   :  V0.2 06.10.2010, try to output the
        ...
        !USE ppm_module_data
        !USE ppm_module_data_part, ONLY: ppm_target_topoid qxb
	...
	!----------------------------------------------------
        ...
        !map_type = ppm_param_map_partial qxb
        ...
        IF ( map_x ) THEN
           ...
           CALL ppm_map_part_partial(topo_id, &
                this%x, &
                this%num_part_real, &
                stat_info_sub) 
