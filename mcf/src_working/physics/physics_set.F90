...
9999    CONTINUE
      ...
      SUBROUTINE physics_set_rho_var(this,d_rho_var,stat_info)
        
        TYPE(Physics), INTENT(INOUT)     :: this
        REAL(MK), INTENT(IN)             :: d_rho_var
        INTEGER, INTENT(OUT)             :: stat_info
        
        stat_info = 0
        
        this%rho_var = d_rho_var
        
        RETURN
        
      END SUBROUTINE physics_set_rho_var


      SUBROUTINE physics_set_bp(this,d_bp,stat_info)
        
        TYPE(Physics), INTENT(INOUT)     :: this
        REAL(MK), INTENT(IN)             :: d_bp
        INTEGER, INTENT(OUT)             :: stat_info
      ...
      END SUBROUTINE physics_set_bp 


      SUBROUTINE physics_set_len_ref(this,d_len_ref,stat_info)
        
        TYPE(Physics), INTENT(INOUT)     :: this
        REAL(MK), INTENT(IN)             :: d_len_ref
        INTEGER, INTENT(OUT)             :: stat_info
        
        stat_info = 0
        
        this%len_ref = d_len_ref
        
        RETURN
        
      END SUBROUTINE physics_set_len_ref
      ...
      SUBROUTINE physics_set_vel_ref(this,d_vel_ref,stat_info)
        
        TYPE(Physics), INTENT(INOUT)     :: this
        REAL(MK), INTENT(IN)             :: d_vel_ref
        INTEGER, INTENT(OUT)             :: stat_info
        
        stat_info = 0
        
        this%vel_ref = d_vel_ref
        
        RETURN
        
      END SUBROUTINE physics_set_vel_ref
...
9999    CONTINUE
      ...
      ! Additional subroutines for the use of tracers only.

      SUBROUTINE physics_set_tracers_radius(this,d_radius,stat_info)
        
        TYPE(Physics), INTENT(INOUT)    :: this
        REAL(MK), INTENT(IN)            :: d_radius                    
        INTEGER, INTENT(OUT)            :: stat_info
        
        stat_info = 0
        
        this%tracers_radius = d_radius
        
        RETURN
        
      END SUBROUTINE physics_set_tracers_radius


      SUBROUTINE physics_set_tracers_rho_ratio(this,d_rho_ratio,stat_info)
        
        TYPE(Physics), INTENT(INOUT)    :: this
        REAL(MK), INTENT(IN)            :: d_rho_ratio        
        INTEGER, INTENT(OUT)            :: stat_info
        
        stat_info = 0
        
        this%tracers_rho_ratio = d_rho_ratio
        
        RETURN
        
      END SUBROUTINE physics_set_tracers_rho_ratio      


      SUBROUTINE physics_set_tracers_c_factor(this,d_c_factor,stat_info)
        
        TYPE(Physics), INTENT(INOUT)    :: this
        INTEGER , INTENT(IN)            :: d_c_factor        
        INTEGER, INTENT(OUT)            :: stat_info
        
        stat_info = 0
        
        this%tracers_c_factor = d_c_factor
        
        RETURN
        
      END SUBROUTINE physics_set_tracers_c_factor  


      SUBROUTINE physics_set_tracers_diffusion(this,d_dp,stat_info)
        
        TYPE(Physics), INTENT(INOUT)    :: this
        REAL(MK), INTENT(IN)            :: d_dp                    
        INTEGER, INTENT(OUT)            :: stat_info
        
        stat_info = 0
        
        this%tracers_dp = d_dp
        
        RETURN
        
      END SUBROUTINE physics_set_tracers_diffusion


      SUBROUTINE physics_set_tracers_near_wall(this,d_near_wall,stat_info)
        ...
        this%tracers_near_wall = d_near_wall
        
        RETURN
        
      END SUBROUTINE physics_set_tracers_near_wall     


      SUBROUTINE physics_set_tracers_restart_num(this,d_restart_num,stat_info)
        
        TYPE(Physics), INTENT(INOUT)    :: this
        INTEGER                         :: d_restart_num
        INTEGER, INTENT(OUT)            :: stat_info
        
        stat_info = 0
        
        this%tracers_restart_num = d_restart_num
        
        RETURN
        
      END SUBROUTINE physics_set_tracers_restart_num     


      SUBROUTINE physics_set_tracers_nbond(this,d_nbond,stat_info)
        ...
        this%tracers_nbond = d_nbond
        
        RETURN
        
      END SUBROUTINE physics_set_tracers_nbond    


      SUBROUTINE physics_set_tracers_K0(this,d_K0,stat_info)
        ...
        this%tracers_K0 = d_K0
        
        RETURN
        
      END SUBROUTINE physics_set_tracers_K0


      SUBROUTINE physics_set_tracers_A(this,d_a,stat_info)
      ...
      END SUBROUTINE physics_set_tracers_A


      SUBROUTINE physics_set_tracers_B(this,d_b,stat_info)
      ...
      END SUBROUTINE physics_set_tracers_B


      SUBROUTINE physics_set_tracers_C(this,d_c,stat_info)
      ...
      END SUBROUTINE physics_set_tracers_C


      SUBROUTINE physics_set_tracers_D(this,d_d,stat_info)
      ...
      END SUBROUTINE physics_set_tracers_D
