      MODULE Class_Colloid
        ...
        TYPE Colloid
           ...
           ! h            : smoothing lenght for caculating
           !                time step.
           ...
           !  phi        : current rotational angle/displacement.
           !               usefull in 2D but not in 3D.
           !  theta      : accumulated rotational angle/displacement.
           !               usefull in 2D but not in 3D.
           ...
           !-------------------------------------------------
           ! arbitrary shape parameters :
           !
           ! coll_arbitrary_num
           !         : number of arbitrary shape colloids
           ! coll_v  : position of vertices (arbitrary shape)
           ! coll_v_flist  
           !         : lines/quadrilaterals of each vertex
           ! coll_f_vlist
           !         : vertices of each line/quadrilateral
           ! coll_n  : normals of lines/quadrilaterals     
           ! coll_v_num 
           !         : number of vertices of each colloid
           ! coll_f_num
           !         : number of lines/quadrilaterals of each colloid
           ! coll_inout
           !         : to differentiate left/right or top/bottom
           ! coll_sdx
           !         : dx used for sorting vertices
           ! coll_snum
           !         : number of division (for sorting)   
           ! coll_sco
           ...
           INTEGER , DIMENSION(:)    , POINTER  :: coll_inout
           REAL(MK)                             :: coll_sdx
           INTEGER                              :: coll_snum 
           INTEGER                              :: coll_sco
...
#include "src/colloid/colloid_new.F90"
#include "src/colloid/colloid_finalize.F90"
#include "src/colloid/colloid_check_parameters.F90"
#include "src/colloid/colloid_adjust_parameters.F90"
#include "src/colloid/colloid_get.F90"
#include "src/colloid/colloid_set.F90"
#include "src/colloid/colloid_check_boundary_particle.F90"
#include "src/colloid/colloid_create_boundary_particle.F90"
#include "src/colloid/colloid_noslip.F90"
#include "src/colloid/colloid_compute_rotation_matrix.F90"
#include "src/colloid/colloid_collect_particles_interaction.F90"
#include "src/colloid/colloid_compute_interaction.F90"
#include "src/colloid/colloid_compute_lubrication_cc.F90"
#include "src/colloid/colloid_compute_lubrication_cw.F90"
#include "src/colloid/colloid_compute_repulsion_cc.F90"
#include "src/colloid/colloid_compute_repulsion_cw.F90"
#include "src/colloid/colloid_compute_acceleration.F90"
#include "src/colloid/colloid_apply_body_force.F90"
#include "src/colloid/colloid_integrate_position.F90"
#include "src/colloid/colloid_integrate_angle.F90"
#include "src/colloid/colloid_integrate_velocity.F90"
#include "src/colloid/colloid_adjust_colloid.F90"
#include "src/colloid/colloid_compute_statistic.F90"
#include "src/colloid/colloid_polar_ellipse.F90"
#include "src/colloid/colloid_polar_star.F90"
#include "src/colloid/colloid_cartesian.F90"
#include "src/colloid/colloid_initialize_image.F90"
#include "src/colloid/colloid_compute_image.F90"
#include "src/colloid/colloid_nearest_image.F90"
#include "src/colloid/colloid_in_nearest_image.F90"
#include "src/colloid/colloid_in_relative_position.F90"
#include "src/colloid/colloid_particle_velocity.F90"
#include "src/colloid/colloid_find_force_extreme.F90"
#include "src/colloid/colloid_compute_dt_f.F90"
#include "src/colloid/colloid_set_flow_developed.F90" 
#include "src/colloid/colloid_adjust_arbitrary_colloid.F90"
