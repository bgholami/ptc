...
mpif_cmblk3_t mpifcmb3r __attribute__((aligned(32))) = {0};
...
mpif_cmblk4_t mpifcmb4r __attribute__((aligned(32))) = {0};
...
mpif_cmblk5_t mpifcmb5r __attribute__((aligned(32))) = {0};
...
mpif_cmblk6_t mpifcmb6r __attribute__((aligned(32))) = {{0}};
...
mpif_cmblk7_t mpifcmb7r __attribute__((aligned(32))) = {{{0}}};
...
mpif_cmblk8_t mpifcmb8r __attribute__((aligned(32))) = {{0}};
